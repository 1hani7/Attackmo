...
export default {
    ...
    setup() {
        const m_name =["1947보스톤","가디언즈","공조2_인터내셔날","나를찾아줘","나를찾아줘(한국)","나이브스아웃",
                "내부자들_디오리지널","노바디","눈물이주룩주룩","더랍스터","더문","더웨일","더킹","데드풀","독전","드림",
                "레이니데이인뉴욕","메기","모노노케히메","미션임파서블_데드레코닝partone","범죄도시3","빅쇼트","사도","상견니",
                "소울","신세계","아메리칸 사이코","아바타_물의길","아저씨","어벤져스_엔드게임","어벤져스","업","엘리멘탈","여름을향한터널,이별의출구",
                "연애빠진로맨스","왕의남자","인생은아름다워","인어공주","인타임","잠","존윅_리로드","지푸라기라도잡고싶은짐승들","천박사퇴마연구소_설경의비밀",
                "친절한금자씨","캐롤","타겟","토르_천둥의신","토이스토리4"];
