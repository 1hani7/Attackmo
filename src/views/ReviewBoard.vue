        ...
        <div id="wrap">
            ...
            <div class="main">
                ...
                <table class="list">
                    ...
                    <tbody>
                        <tr class="con" v-for="(item, index) in paginatedList" :key="index">
                        <td class="n">{{ (currentPage - 1) * itemsPerPage + index + 1 }}</td>
                ...
                <div class="mobileList">
                    <div class="post" v-for="(item, index) in paginatedList" :key="index">
            ...
            <div class="page_list">
                ...
                <RouterLink v-for="page in pageCount" :key="page" :to="'/Rlist/' + page">{{ page }}</RouterLink>
...
export default {
    data(){
        return{
            ...
            itemsPerPage: 10, // 페이지 당 표시할 게시글 수
